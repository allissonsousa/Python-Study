...
valor da casa, o salário do comprador e em quantos ANOS ele vai pagar.
 ...
 """
casa = float(input('Qual o valor da casa que voce deseja adiquirir ? '))
sal = float(input('Qual o valor do seu salário mensal ? '))
...
if mens > (sal * 30 / 100):  # calcula se a parcela é maior que 30% do salário
    print(f'Infelizmente o seu salário não é compativel com o valor da parcela de R${mens:.2f}')
else:
